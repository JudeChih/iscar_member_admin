...
@extends('index')
@section("content_tip")
<script type="text/javascript" src="/js/view/testkotsms.js"></script>
  <div class="prompt_body_b">
    <div class="prompt_box_b panel-primary">
      ...
      <h2></h2>
      <div>
        <button class="btn btn-primary kotsms_yes">確認</button>
      </div>
    </div>
  </div>
@endsection
...
<div class="panel_detail col-md-12 col-sm-12 col-xs-12 p_l_r_dis">
  <form action="/testtools/testkotsms" class="col-md-12 col-sm-12 col-xs-12 p_l_r_dis form-horizontal" method="post">
    {!! csrf_field() !!}
    <input type="hidden" name="testtype" value="2">
    <div class="form-group">
      <label for="mobile" class="col-md-4 col-sm-4 col-xs-4 control-label">收件人電話</label>
      <div class="col-md-6 col-sm-6 col-xs-8">
        <input type="text" name="mobile" class="form-control" data-toggle="tooltip" maxlength="10" title="請填入10碼手機號碼，09開頭的手機號碼" value="">
      </div>
    </div>
